...
const my3FavoriteTVShows = ['Percy Jackson', 'Harry Potter', 'Jujutsu Kaisen']
...
let Numberof = my3FavoriteTVShows.length == 3
...
const isRandomTVShowIncluded = `${randomTVShow} é uma das 3 favoritas? ${my3FavoriteTVShows.includes(randomTVShow)}`
...
let typeSentence = `O tipo de dado que a const "isRandomTVShowIncluded" armazena é: TIPO_DE_DADO.`
typeSentence = typeSentence.replace('TIPO_DE_DADO', typeof isRandomTVShowIncluded)
...
let numChar = 39
console.log(`A string que a \"typeSentence\" armazena tem mais de ${numChar} caracteres? ${typeSentence.lenght > 39}`)
...
// O resultado é TRUE devido à conversão de 0 = false e 1 = true
...
let verify = agesSum <= 92
console.log(`A soma entre o 1º e o 3º item de \"ages\" é menor ou igual a 92. Essa afirmação é: ${verify}.`)
...
const isNotAString = !typeof randomTVShow
...
let verifynumbers = evenNumbers.includes(8)
